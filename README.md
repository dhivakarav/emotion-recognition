...
Data Processing: Includes custom scripts for image preprocessing and normalization.
...
Feature Extraction: Processes the facial region to identify key expression markers.

Classification: A Convolutional Neural Network (CNN) predicts the emotion based on learned patterns.
